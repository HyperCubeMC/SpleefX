 ...
 */
package org.moltenjson.configuration.select;
...
public class SelectableConfiguration implements Lockable<SelectableConfiguration>, Refreshable<SelectableConfiguration> {
     ...
     * with {@link SelectKey} to their class. If the class does not channelTo any
    ...
    /**
     * Assigns the field to its JSON value. If the {@link #content} does not channelTo declaration
