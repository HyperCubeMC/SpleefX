 ...
 */
package org.moltenjson.configuration.direct;
...
import org.moltenjson.json.Lockable;
 ...
 */
@SuppressWarnings("all") // From library, stupid warnings like unused and access should be suppressed
public class DirectConfiguration implements Lockable<DirectConfiguration>, Refreshable<DirectConfiguration> {
     ...
     *                    this may be left null.
     */
    public final void save(Consumer<IOException> onException, Gson gson) {
        try {
